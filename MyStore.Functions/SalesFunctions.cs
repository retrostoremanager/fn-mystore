...
public class SalesFunctions
{
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "sales")] HttpRequestData req)
    {
        ...
        var response = await _salesService.GetAllSalesAsync();
    ...
    public async Task<HttpResponseData> GetSalesByCustomer(
        ...
        int customerId)
    {
        _logger.LogInformation("Getting sales for customer ID: {CustomerId}", customerId);

        var response = await _salesService.GetSalesByCustomerIdAsync(customerId);
        return await CreateHttpResponse(req, response);
    }
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "sales/date-range")] HttpRequestData req)
    {
        ...
        _logger.LogInformation("Getting sales from {StartDate} to {EndDate}", startDate, endDate);

        var response = await _salesService.GetSalesByDateRangeAsync(startDate, endDate);
        return await CreateHttpResponse(req, response);
    }
        ...
        [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "sales")] HttpRequestData req)
    {
        ...
        var response = await _salesService.CreateSaleAsync(request);
        ...
        int id)
    {
        ...
        var response = await _salesService.DeleteSaleAsync(id);
