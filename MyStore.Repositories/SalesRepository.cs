...
public class SalesRepository : ISalesRepository
{
    ...
    public async Task<List<Sale>> GetAllAsync(int companyId)
    {
        ...
        const string sql = @"SELECT id, company_id, customer_id, user_id, (total - tax) AS subtotal, tax, total,
    ...
    public async Task<Sale> CreateAsync(Sale sale)
    {
        ...
        try
        {
            const string insertSale = @"INSERT INTO sale (company_id, customer_id, user_id, tax, total,
                    payment_method, sale_date, notes)
                VALUES (@CompanyId, @CustomerId, @UserId, @Tax, @Total, @PaymentMethod, @SaleDate, @Notes)
                RETURNING id";
